...
class PRNet(nn.Module):
    ...
    def _train_one_epoch(self, epoch, train_loader, opt, boardio):
        self.train()
        total_loss = 0
        rotations_ab = []
        translations_ab = []
        ...
        for it, data in enumerate(tqdm(train_loader, total=len(train_loader))):
        ...
        # tensortboard stuff
        boardio.add_scalar("A->B/train/loss", avg_loss, epoch)
        boardio.add_scalar("A->B/train/rotation/MSE", r_ab_mse, epoch)
        boardio.add_scalar("A->B/train/rotation/RMSE", r_ab_rmse, epoch)
        boardio.add_scalar("A->B/train/rotation/MAE", r_ab_mae, epoch)
        boardio.add_scalar("A->B/train/translation/MSE", t_ab_mse, epoch)
        boardio.add_scalar("A->B/train/translation/RMSE", t_ab_rmse, epoch)
        boardio.add_scalar("A->B/train/translation/MAE", t_ab_mae, epoch)
        
        return info

    def _test_one_epoch(self, epoch, test_loader, boardio):
        self.eval()
        total_loss = 0
        rotations_ab = []
        translations_ab = []
        ...
        # tensortboard stuff
        boardio.add_scalar("A->B/test/loss", avg_loss, epoch)
        boardio.add_scalar("A->B/test/rotation/MSE", r_ab_mse, epoch)
        boardio.add_scalar("A->B/test/rotation/RMSE", r_ab_rmse, epoch)
        boardio.add_scalar("A->B/test/rotation/MAE", r_ab_mae, epoch)
        boardio.add_scalar("A->B/test/translation/MSE", t_ab_mse, epoch)
        boardio.add_scalar("A->B/test/translation/RMSE", t_ab_rmse, epoch)
        boardio.add_scalar("A->B/test/translation/MAE", t_ab_mae, epoch)
